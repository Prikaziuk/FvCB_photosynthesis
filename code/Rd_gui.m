function [Rd_val] = Rd_gui(f, UP, LEFT, LEFT_SHIFT)
%% control position
font = 10.5;
font_units = 10;
width_units = 100;
...
%% 1.2
Rd_val = uicontrol(f, 'Style', 'edit');
Rd_val.String = init_val;
Rd_val.Position(1) = left_2;
Rd_val.Position(2) = UP - 1;
Rd_val.Callback = {@bg_cb, too_big};
