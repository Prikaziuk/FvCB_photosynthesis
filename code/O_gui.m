function [O_val] = O_gui(f, UP, LEFT, LEFT_SHIFT)
%% control position
font = 10.5;
font_units = 10;
width_units = 100;
...
%% 1.2
O_val = uicontrol(f, 'Style', 'edit');
O_val.String = init_val;
O_val.Position(1) = left_2;
O_val.Position(2) = UP - 1;
O_val.Callback = {@bg_cb, too_big};
